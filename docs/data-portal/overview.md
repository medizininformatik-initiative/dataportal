...
| ------------------------- | ---------------------------------------------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| dataportal-ui                     | Dataportal UI                                         |                 | [Overview](https://github.com/medizininformatik-initiative/feasibility-gui), | Dataportal UI                                                            |
| dataportal-backend                     | Dataportal Backend                                       |                 | [Overview](https://medizininformatik-initiative.github.io/dataportal-backend/overview.html), [Configuration](https://medizininformatik-initiative.github.io/dataportal-backend/configuration.html), [API](https://medizininformatik-initiative.github.io/dataportal-backend/api.html) | Dataportal Backend                                                            |
| dataportal-availability-updater                  | Dataportal Availability Updater                                       |                 | [Overview](https://github.com/medizininformatik-initiative/dataportal-availibility-updater), | Dataportal Backend                                                            |